...
mod error_handling_tests {
    ...
    async fn test_timeout_validation_error_handling() {
        ...
        for (heartbeat, min_timeout, max_timeout) in invalid_timeouts {
            ...
            assert!(result.is_err(), "Timeout config {:?} should be invalid", (heartbeat, min_timeout, max_timeout));
    ...
    async fn test_authorization_error_handling() {
        ...
        let _result = node.add_node_with_auth(2, "127.0.0.1:8082".to_string(), Some(auth_ctx.clone())).await;
